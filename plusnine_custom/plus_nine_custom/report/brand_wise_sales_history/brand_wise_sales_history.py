...
def get_item_details():
	details = frappe.db.get_all("Item", fields=["name", "item_name", "item_group", "brand"])
	item_details = {}
	for d in details:
		item_details.setdefault(d.name, frappe._dict({"item_name": d.item_name, "item_group": d.item_group, "brand": d.brand}))
	return item_details
...
def get_sales_order_details(company_list, filters):
	...
	if filters.get("brand"):
		query = query.where(db_so_item.brand == filters.brand)
